...
V_sub, F_sub = sqrt.subdivide(mesh.vertices, mesh.faces, iterations=1) # faces multiply by 4 each time
V_sub1, F_sub1 = sqrt.subdivide(mesh1.vertices, mesh1.faces, iterations=1)
V_sub2, F_sub2 = sqrt.subdivide(mesh2.vertices, mesh2.faces, iterations=1)
...
V_sub, F_sub = sqrt3.subdivide(mesh.vertices, mesh.faces, iterations=2)
